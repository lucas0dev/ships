defmodule ShipsWeb.LobbyChannelTest do
  ...
  describe "handle_in('find_game') when there are none game_ids tracked by Presence" do
  ...
  describe "handle_in('find_game') when there is already game tracked by Presence" do
